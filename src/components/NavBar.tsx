  ...
  return (
    <>
      ...
      <nav className="max-w-5xl mx-auto flex items-center justify-between relative z-50">
        <h1 className="text-xl font-bold text-gray-400">Taylor W. Cooper</h1>
        ...
        >
          {[
            ...
            <li key={name}>
              <Link
                href={href}
                className="block px-4 py-2 text-gray-400 hover:-translate-y-[3px] hover:text-gray-200 transition transform"
