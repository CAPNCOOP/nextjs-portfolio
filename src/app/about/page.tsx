  ...
  return (
    ...
    >
      <Head>
        ...
        <meta
          name="description"
          content="Learn more about Taylor Cooper, a full-stack developer and former Marine photographer based in Asheville, NC."
        />
      </Head>
          ...
          <h1 className="text-4xl font-bold mb-4">About Me</h1>
            ...
            <section className="mt-12">
              ...
              <div className="border-l-2 border-gray-300 pl-4 space-y-4">
                <div>
                  <span className="font-medium text-gray-400">2016</span> — Enlisted in the Marine Corps, specializing in communication and media
                </div>
                <div>
                  <span className="font-medium text-gray-400">2017–2021</span> — Led visual storytelling efforts across global deployments, mentored junior Marines
                </div>
                <div>
                  <span className="font-medium text-gray-400">2021</span> — Began formal training in Software and Web Development at A-B Tech
                </div>
                <div>
                  <span className="font-medium text-gray-400">2022–2023</span> — Worked as Partner Success Executive, managing 200+ client accounts
                </div>
                <div>
                  <span className="font-medium text-gray-400">2024</span> — Completed major capstone project: Blue Ridge Bounty farmers market platform
                </div>
                <div>
                  <span className="font-medium text-gray-400">2025</span> — Launching tech career with a focus on full-stack web development and open source
                </div>
              </div>
            </section>
            ...
            <section className="mt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-xl font-medium mb-2">Creative</h3>
                  <ul className="list-disc list-inside space-y-1">
