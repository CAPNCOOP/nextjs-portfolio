...
export default function BlueRidgeBountyPage() {
  return (
    <>
      <SEO 
        title="Taylor Cooper | Blue Ridge Bounty Project" 
        description="A full-featured farmers market platform designed and built by Taylor Cooper, supporting local vendors and community markets."
      />
      <section className="max-w-5xl mx-auto p-8">

        <h1 className="text-4xl font-bold text-gray-700 mb-4">Blue Ridge Bounty</h1>
        ...
        <div className="mb-6">
          <h2 className="text-2xl text-gray-700 font-semibold mb-2">Tech Stack</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl text-gray-700 font-semibold mb-2">Key Features</h2>
          <ul className="list-disc list-inside text-gray-600">
        ...
        <div className="flex flex-wrap gap-4">
          <a
            ...
            className="bg-gray-800 text-white px-6 py-2 rounded hover:bg-gray-600 transition"
          >
            Visit Live Site
          </a>
          <a
        ...
        <div className="mt-16">
          <h2 className="text-2xl text-gray-700 font-semibold mb-8">Feature Gallery</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-xl text-gray-700 font-bold mb-2">Log In</h3>
            ...
            <div>
              <h3 className="text-xl text-gray-700 font-bold mb-2">Vendor Dashboard</h3>
            ...
            <div>
              <h3 className="text-xl text-gray-700 font-bold mb-2">Vendor Profile</h3>
            ...
            <div>
              <h3 className="text-xl text-gray-700 font-bold mb-2">Vendor Products</h3>
            ...
            <div>
              <h3 className="text-xl text-gray-700 font-bold mb-2">All Vendors</h3>
            ...
            <div>
              <h3 className="text-xl text-gray-700 font-bold mb-2">Search Function</h3>
            ...
            <div>
              <h3 className="text-xl text-gray-700 font-bold mb-2">Admin Dashboard</h3>
            ...
            <div>
              <h3 className="text-xl text-gray-700 font-bold mb-2">Admin User Control</h3>
            ...
            <div>
              <h3 className="text-xl text-gray-700 font-bold mb-2">Image Cropper</h3>
