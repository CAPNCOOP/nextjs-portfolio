      ...
      <div className="mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-gray-400 text-sm mb-3">Secure login for users, vendors, admins, and super admins.</p>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-3">Manage products, RSVPs, and view profile analytics.</p>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-3">Public-facing profiles with product galleries.</p>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-3">Full product listings with category filtering.</p>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-3">Directory-style view of all approved vendors.</p>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-3">Dynamic search bar for vendors and products.</p>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-3">Approve vendors, control homepage status, manage RSVPs.</p>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-3">Toggle user status and control platform access.</p>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-3">Upload and crop product images using Cropper.js.</p>
